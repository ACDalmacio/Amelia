  ...
  .bg-top {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background-color:#BBA732;">

        <ul class="navbar-nav ml-auto">

        <li class="nav-item dropdown no-arrow">
          <a class="nav-link " href="index.php" role="button">
              <div class="navbar-brand font-weight-bold text-white medium">Amelia's Kitchen Cafe Sales & Inventory Tracking System </div>
              </a>
          </li>
  </ul>
