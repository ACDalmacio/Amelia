...
<?php
  ...
  $result = mysqli_query($db, $query) or die(mysqli_error($db));
    ...
    {   
      ...
      $id = $_GET['id'];
?>
          <center><div class="card shadow mb-3 col-xs-12 col-md-6 border-bottom-danger">
            <div class="card-header py-3">
            <a href="employee.php" class="close"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i></a>
