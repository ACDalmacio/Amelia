...
<?php
  ...
  $result2 = mysqli_query($db, $query2) or die(mysqli_error($db));
    ...
    $id = $_GET['id'];
?>
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-danger">
            <div class="card-header py-3">
            <a href="user.php?action=add" type="button" class="close"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> </a>
