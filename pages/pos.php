			...
			<div class="row">
				<div class="col-6">
					<div class="card-header py-2">
						<h4 class="m-1 text-lg font-weight-bold text-dark">Product category</h4>
					</div>
					<!-- /.panel-heading -->
					<div class="card-body">
						<!-- Nav tabs -->
						<ul class="nav nav-tabs">
							<li class="nav-item ">
								<a class="nav-link font-weight-bold text-dark " href="#" data-target="#cakes"
									data-toggle="tab" id="landing_tab">Whole Cakes</a>
							</li>
							<li class="nav-item">
								<a class="nav-link font-weight-bold text-dark" href="#cookies" data-target="#cookies"
							...
							<li class="nav-item">
								<a class="nav-link font-weight-bold text-dark" href="#pastries" data-target="#pastries"
									data-toggle="tab">Pastries</a>
							</li>
							<li class="nav-item">
								<a class="nav-link font-weight-bold text-dark" href="#minicakes" data-toggle="tab">Mini
									Cakes</a>
							</li>
							<li class="nav-item ">
								<a class="nav-link font-weight-bold text-dark" href="#slicecakes"
									data-toggle="tab">Slice
									Cakes</a>
							</li>
						</ul>
										...
										<table class="table">
											...
											<tr>
												...
												<input type="hidden" name="prod_qty[]"
													value="<?php echo $product['prod_qty']; ?>">
												...
												<td>
													<a
														href="pos.php?action=delete&id=<?php echo $product['id']; ?>">
