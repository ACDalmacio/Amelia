	...
	<div class="card-body">
		<div class="form-group row text-left mb-0">
			...
			<div class="col-sm-3 py-1">
				<a href="transaction.php?action=add" class="close">x</a>
				<h6>
					Date: <?php echo $date; ?>
				</h6>
			</div>
			...
			<div class="col-sm-4 py-1">
				<table width="100%">
					<tr>
						...
						<td class="text-right">₱ <?php echo $sub; ?>
						</td>
					</tr>
					<tr>
						<td class="font-weight-bold">Less VAT</td>
						<td class="text-right">₱ <?php echo $less; ?>
						</td>
					</tr>
					<tr>
						<td class="font-weight-bold">Net of VAT</td>
						<td class="text-right">₱ <?php echo $net; ?>
						</td>
					</tr>
					<tr>
						<td class="font-weight-bold">Add VAT</td>
						<td class="text-right">₱ <?php echo $add; ?>
						</td>
					</tr>
					<tr>
